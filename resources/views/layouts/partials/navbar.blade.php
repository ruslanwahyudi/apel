<div class="headerbar">
  ...
  <div class="headerbar-left">
    <a href="{{ route('admin.dashboard') }}" class="logo"><img alt="Logo" src="{{ asset('storage/'.$settings->app_logo ?? 'assets/images/logo.png') }}" /> <span>Banyupelle</span></a>
  </div>
    ...
    <ul class="list-inline float-right mb-0">
      ...
      <li class="list-inline-item dropdown notif">
        <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
          <img src="https://ui-avatars.com/api/?name={{ Auth::user()->name }}" alt="Profile image" class="avatar-rounded">
        </a>
        <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
          ...
          <!-- item-->
          <a target="_blank" href="{{ route('home') }}" class="dropdown-item notify-item">
