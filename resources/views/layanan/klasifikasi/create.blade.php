    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="breadcrumb-holder">
                <h1 class="main-title float-left">Tambah Klasifikasi Identitas</h1>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3><i class="fa fa-plus"></i> Tambah Klasifikasi Identitas</h3>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('layanan.klasifikasi.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="nama_klasifikasi">Nama Klasifikasi <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control @error('nama_klasifikasi') is-invalid @enderror" id="nama_klasifikasi" name="nama_klasifikasi" value="{{ old('nama_klasifikasi') }}" required>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('layanan.klasifikasi') }}" class="btn btn-secondary">Kembali</a>
                            </div>
                        </div>
                    </form>
                </div>
