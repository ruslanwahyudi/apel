...
<head>
    <meta charset="utf-8">
    <title>{{ $kategori->nama ?? 'Surat Pengantar' }}</title>
    <style>
        @page {
...
<body>
    <div class="surat-content">
        ...
        <div class="isi-surat">
            ...
            <p>Surat pengantar ini dibuat untuk keperluan <strong>{{ $data['keperluan'] ?? '_______________' }}</strong> di <strong>{{ $data['tujuan'] ?? '_______________' }}</strong>.</p>
