...
<body>
    <div class="surat-content">
        ...
        <div class="isi-surat">
            ...
            <p>Bahwa orang tersebut diatas benar-benar penduduk desa banyupelle kecamatan palengaan kabupaten pamekasan dan yang bersangkutan benar-benar wali dari anak {{ $data['nama_anak'] ?? '_______________' }}, siswi SD/ MI {{ $data['sekolah_anak'] ?? '_______________' }}, karena kedua orang tua anak tersebut bekerja diluar <strong>{{ $data['tempat_bekerja'] ?? '_______________' }}</strong>.</p>
