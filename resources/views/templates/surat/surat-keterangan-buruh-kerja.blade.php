...
<head>
    <meta charset="utf-8">
    <title>Surat Keterangan Buruh Kerja</title>
    <style>
        @page {
...
<body>
    <div class="surat-content">
        ...
        <div class="isi-surat">
            ...
            <p>Bahwa orang tersebut diatas benar-benar penduduk Desa Banyupelle Kecamatan Palengaan Kabupaten Pamekasan dan yang bersangkutan selama ini benar-benar menjadi Buruh Kerja di {{ $data['tempat_bekerja'] ?? '_______________' }}</strong>.</p>
