                ...
                <div class="menerangkan-content">
                    <table>
                        <tr>
                            ...
                            <td>{{ $data['nama_suami'] ?? '_______________' }}</td>
                        </tr>
                        <tr>
                            <td>NIK</td>
                            <td style="text-align: center;">:</td>
                            <td>{{ $data['nik_suami'] ?? $data['no_ktp_suami'] ?? '_______________' }}</td>
                        </tr>
                        <tr>
                            <td>Tempat Tanggal Lahir</td>
                            <td style="text-align: center;">:</td>
                            <td>{{ $data['tempat_lahir_suami'] ?? '_______________' }}, 
                                @php
                                    $tanggalLahir = $data['tanggal_lahir_suami'] ?? null;
                        ...
                        <tr>
                            <td>Pekerjaan</td>
                            <td style="text-align: center;">:</td>
                            <td>{{ $data['pekerjaan_suami'] ?? '_______________' }}</td>
                        </tr>
                        <tr>
                            <td>Alamat</td>
                            <td style="text-align: center;">:</td>
                            <td>{{ $data['alamat_suami'] ?? '_______________' }}</td>
                        </tr>
                    </table>
                    ...
                    <table>
                        <tr>
                            <td style="width: 280px;">Nama</td>
                            <td style="width: 20px; text-align: center;">:</td>
                            <td>{{ $data['nama_istri'] ?? '_______________' }}</td>
                        </tr>
                        <tr>
                            <td>NIK</td>
                            <td style="text-align: center;">:</td>
                            <td>{{ $data['nik_istri'] ?? $data['no_ktp_istri'] ?? '_______________' }}</td>
                        </tr>
                        <tr>
                            <td>Tempat Tanggal Lahir</td>
                            <td style="text-align: center;">:</td>
                            <td>{{ $data['tempat_lahir_istri'] ?? '_______________' }}, 
                                @php
                                    $tanggalLahir = $data['tanggal_lahir_istri'] ?? null;
                        ...
                        <tr>
                            <td>Pekerjaan</td>
                            <td style="text-align: center;">:</td>
                            <td>{{ $data['pekerjaan_istri'] ?? '_______________' }}</td>
                        </tr>
                        <tr>
                            <td>Alamat</td>
                            <td style="text-align: center;">:</td>
                            <td>{{ $data['alamat_istri'] ?? '_______________' }}</td>
                        </tr>
                    </table>
                </div>
            </div>
            
            <p>Bahwa orang tersebut penduduk desa banyupelle kecamatan palengaan kabupaten pamekasan dan orang tersebut benar-benar suami isteri yang sah berdasarkan pernikahan secara agama tetapi tidak tercatat di Kantor Urusan Agama (KUA).</p>
